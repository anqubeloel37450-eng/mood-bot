...
async def handle_question(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if answer not in ANSWERS:
        ...
        # Возвращаем текущее состояние, чтобы пользователь мог попробовать еще раз
...
# НОВАЯ ФУНКЦИЯ ДЛЯ ЗАПУСКА ПЛАНИРОВЩИКА
...
def main() -> None:
    ...
    # ИЗМЕНЕННЫЙ СПОСОБ СБОРКИ ПРИЛОЖЕНИЯ
    # Теперь мы используем post_init для безопасного запуска планировщика
